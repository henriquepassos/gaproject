function best_result = run_ga_comparisson(x, y, NIND, MAXGEN, NVAR, ELITIST, STOP_PERCENTAGE, PR_CROSS, PR_MUT, OPT, CROSSOVER, MUTATION, SELECTION, LOCALLOOP, ah1, ah2, ah3,k)
% usage: run_ga(x, y, 
%               NIND, MAXGEN, NVAR, 
